        ...
        <form className="mt-6 space-y-4" onSubmit={onSubmit}>
          ...
          <div>
            ...
            <div className="relative">
              <input
                className="w-full rounded-xl border border-runme-border bg-runme-raised py-2.5 pl-3 pr-11 text-sm text-white placeholder:text-runme-muted focus:border-runme-accent/50 focus:outline-none focus:ring-1 focus:ring-runme-accent/30"
                value={form.password}
              ...
              <button
                type="button"
                className="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-runme-muted transition-colors hover:bg-white/5 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-runme-accent/40"
